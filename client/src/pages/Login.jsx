...
const Login = () => {
  ...
  // Redirect instantly if user bounds back here while already authenticated
  useEffect(() => {
    if (user) {
  ...
  return (
    <div style={{ position: 'relative', minHeight: '100vh', overflow: 'hidden', padding: '1px' }}>
      ...
      <div className="page-header" style={{ textAlign: 'center', border: 'none' }}>
        ...
        <p style={{ color: 'var(--text-secondary)' }}>Sign in to continue to ElectoralWatch</p>
      </div>
      <div className="card">
        {errorMsg && (
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-group">
            ...
            <input type="email" className="form-control" placeholder="account@example.com" value={email} onChange={(e) => setEmail(e.target.value)} />
          </div>
          <div className="form-group">
